...
## Summary
- 274 nodes · 513 edges · 19 communities (15 shown, 4 thin omitted)
...
Cohesion: 0.10
Nodes (18): App(), SignaturePadProps, styles, COLORS, AgreementModalProps, styles, CheckoutModal(), CheckoutModalProps (+10 more)
...
Cohesion: 0.11
Nodes (18): initConnection(), store, getCycleDates(), getSafeNepaliDate(), useCheckoutController(), addCheckoutSettlement(), terminateTenancy(), useInvoiceController() (+10 more)
...
Cohesion: 0.42
Nodes (8): usePaymentController(), PaymentModal(), addPayment(), getPaymentsForInvoice(), getTotalPaidForInvoice(), initPaymentSchema(), Payment, syncInvoiceStatus()
...
## Knowledge Gaps
- **87 isolated node(s):** `store`, `name`, `slug`, `version`, `orientation` (+82 more)
...
- **What connects `store`, `name`, `slug` to the rest of the system?**
