...
## Corpus Check
- 42 files · ~41,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 274 nodes · 529 edges · 19 communities (15 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b49749f7`
...
Cohesion: 0.11
Nodes (17): SignaturePadProps, styles, COLORS, useAgreementController(), AgreementModal(), AgreementModalProps, styles, CheckoutModalProps (+9 more)
...
Cohesion: 0.24
Nodes (18): getDB(), initConnection(), store, useCheckoutController(), addCheckoutSettlement(), CheckoutSettlement, getCheckoutSettlement(), initCheckoutSchema() (+10 more)
...
Cohesion: 0.13
Nodes (22): checkoutSettlements, houses, invoices, meterReadings, payments, roomPostings, rooms, tenancies (+14 more)
...
Cohesion: 0.28
Nodes (12): MarketplaceFeed(), styles, useListingController(), useMarketplaceController(), addRoomPosting(), deleteRoomPosting(), getAllPublicPostings(), getPostingForRoom() (+4 more)
...
## Knowledge Gaps
- **87 isolated node(s):** `CheckoutModalProps`, `styles`, `name`, `slug`, `version` (+82 more)
...
- **What connects `CheckoutModalProps`, `styles`, `name` to the rest of the system?**
